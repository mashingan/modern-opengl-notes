...
#[
# This is used for simply 3 elements of vertices
var elements = [
  0'u32, 1, 2
]
var vertices = [
...
var vertices = [
  -0.5'f,  0.5, 1, 0, 0,  # top-left red
     0.5,  0.5, 0, 1, 0,  # top-right green
     0.5, -0.5, 0, 0, 1,  # bottom-right green
     0.5, -0.5, 0, 0, 1,  # bottom-right green
    -0.5, -0.5, 1, 1, 1,  # bottom-left white
    -0.5,  0.5, 1, 0, 0,  # top-left red
]
]#

# using element allows for vertex reuse
var elements = [
  0'u32, 1, 2,
  2, 3, 0
]
